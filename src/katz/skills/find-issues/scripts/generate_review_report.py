...
def write_report_assets(output):
    """Place branded assets beside a generated report."""
    destination = Path(output).parent / "logo.png"
...
"""
    ...
    brand_logo_fallback = (
        ...
        ""
    )
...
<div class="ep-brand">
  <img src="logo.png" alt="Expected Parrot logo"
       onerror="this.onerror=null;this.src='{brand_logo_fallback}'">
  <div class="ep-brand-text">
    <div class="ep-brand-name">Expected Parrot</div>
    <div class="ep-brand-subtitle">Paper explorer · version-aware review ledger</div>
  </div>
</div>
